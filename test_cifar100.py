...
def get_args():
    ...
    parser.add_argument('--best_model_path', type=str, default='CIFAR100_test_models/_best_model.pth')
    parser.add_argument('--last_model_path', type=str, default='CIFAR100_test_models/_last_model.pth')
    parser.add_argument('--model', default='ResNet18', type=str, help='model name')
    parser.add_argument('--n_ex', type=int, default=10000)
    parser.add_argument('--batch_size', type=int, default=500)
    parser.add_argument('--out_dir', type=str, default='./CIFAR100_test_results')
